...
<html Document!>
    ...
    <body>
            ...
            <nav class="navbar">
                ...
                <ul class="nav-bar">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a onclick="myFunction()" href="logout.php">Log Out</a><a onclick="myFunction()" href="logout.php">Log Out</a>
                        </div>
                    </div>
                </a></li>
                </ul>
        ...
        <div class="body">
            ...
            <div class="row">
                <div class="overlay">
                    <img class="image" src="images/start girl.jpg">
                    <div class="note"><p>Star Girl</p></div>
                </div>
                <div class="overlay">
                    <img class="image" src="images/the flash.jpg">
                    <div class="note"><p>Flash</p></div>
                </div>
            </div>
