...
<html Document!>
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="row">
                <div class="overlay">
                    <img class="image" src="images/luca.jpg">
                    <div class="note"><p>Luca</p></div>
                </div>
                <div class="overlay">
                    <img class="image" src="images/cinderella story.jpg">
                    <div class="note"><p>Cinderella Story</p></div>
                </div>
                <div class="overlay">
                    <img class="image" src="images/spin.jpg">
                    <div class="note"><p>Spin</p></div>
                </div>
                <div class="overlay">
                    <img class="image" src="images/spirit.jpg">
                    <div class="note"><p>Spirit</p></div>
                </div>
                <div class="overlay">
                    <img class="image" src="images/milly and the margical journey.jpg">
                    <div class="note"><p>Milly And The Margical Journey</p></div>
                </div>
            </div>
